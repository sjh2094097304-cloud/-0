...
class WeatherWidget4x2Provider : AppWidgetProvider() {
    ...
    override fun onEnabled(context: Context) {
        ...
        try {
            ...
            FileLogger.e(TAG, "onEnabled: worker 入队失败", e)
        }
    }
    ...
    companion object {
        ...
        private const val TAG = "Widget4x2Provider"
        private const val WORK_NAME = "weather_widget_4x2_periodic"
        private const val WORK_NAME_ONETIME = "weather_widget_4x2_onetime"
            ...
            try {
                ...
                if (ids.isNotEmpty()) {
                    if (weather != null && cityName != null) {
                        ...
                        WeatherWidgetUpdater.update4x2All(context, weather, cityName)
                    } else {
        ...
        /** Lightweight periodic refresh for weather data. */
        fun enqueueWorker(context: Context) {
            ...
            val request = PeriodicWorkRequestBuilder<WeatherWidget4x2Worker>(
        ...
        fun enqueueOneTimeWorker(context: Context, trigger: String = "onetime") {
            ...
            val inputData = Data.Builder()
                ...
                .build()
            val request = OneTimeWorkRequestBuilder<WeatherWidget4x2Worker>()
